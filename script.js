...
const ui = {
    appendMessage: (message, type) => {
        ...
        // Regular messages have username formatting
        else {
...
const initApp = () => {
    ...
    if (savedData.peerId && savedData.username) {
        ...
        // For first-time users, create a random ID
...
elements.locationShareButton.addEventListener('click', sharing.shareLocation);
